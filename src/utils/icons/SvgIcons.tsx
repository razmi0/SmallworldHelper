import { IconName, SvgProps } from "@/types/types";
...
export const Reset = ({ color, size }: SvgProps) => {
  return (
    <svg width={size[0]} height={size[1]} viewBox="-8 -8 39.60 39.60" fill="none">
      <g strokeWidth="0"></g>
      <g strokeLinecap="round" strokeLinejoin="round"></g>
      <g>
        <path d="M15 12H9" stroke={color} strokeWidth="1.5" strokeLinecap="round"></path>
        <path
...
type IconComponents = Record<IconName, FC<SvgProps>>;
export const SvgsComponents: IconComponents = {
  close: Close,
  reset: Reset,
  undo: Undo,
  redo: Redo,
